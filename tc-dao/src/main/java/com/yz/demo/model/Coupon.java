...
public class Coupon {
    ...
    public static final String ID = "优惠券ID";
    public static final String OWNER_TYPE = "1.平台 2.商场 3.店铺";
    public static final String OWNER_ID = "优惠券拥有者ID";
    public static final String OWNER_NAME = "优惠券拥有者名称";
    public static final String ACTIVITY_ID = "活动ID 如果单独创建，活动ID为0";
    public static final String COUPON_NAME = "优惠券名称";
    public static final String COUPON_USE_TYPE = "使用类型 1.免费券 2.付费券";
    public static final String COUPON_NO = "优惠券sku编码";
    public static final String PRICE = "付费券价格";
    public static final String COUPON_PACKAGE_ID = "券包id(0表示不是券包券 大于0表示属于一个券包)";
    public static final String PER_PERSON_LIMIT = "一个人最多领取优惠券的张数";
    public static final String PER_ORDER_LIMIT = "每个订单优惠券可以使用的张数";
    public static final String COUPON_TYPE_ID = "优惠券类型ID  51.无门槛现金抵用券 52.满减券 53.叠加满减券 54.阶梯满减券 55.折扣券 56.赠品券";
    public static final String START_TIME = "优惠券生效时间";
    public static final String END_TIME = "优惠券过期时间";
    public static final String PENDING_TIME = "优惠券预热时间 如果有必须早于发券开始时间";
    public static final String IS_SHARED_SUBPROMOTION = "是否可以叠加订单促销 1.是 0.否";
    public static final String IS_SHARED_COUPON = "是否可以叠加优惠券促销 1.是 0.否";
    public static final String REDIRECT_TYPE = "0.页面无此选项展示 1.点击券面进入活动页面 2.券面无点击效果";
    public static final String REDIRECT_URL = "跳转页面url地址";
    public static final String IS_MUST_APPLY = "是否必须报名（0：否；1：是） E端才有";
    public static final String AFFORD_COST_TYPE = "1.百分比 2.暂时无用，以后扩展";
    public static final String AFFORD_COST_VALUE = "如果bear_cost_type=1 表示分摊率(bear_cost_value=1表示自己承担费用 小于1表示需要下级分摊);如果...";
    public static final String COUPON_DISPATCH_TYPE = "1.统一发券 2.分渠道发券 3.线下发券";
    public static final String ISSUE_START_TIME = "优惠券发放起始时间 只有coupon_dispatch_type=1 统一发券时不为空";
    public static final String ISSUE_END_TIME = "优惠券发放截止时间 只有coupon_dispatch_type=1 统一发券时不为空";
    public static final String ISSUED_TOTAL_AMOUNT = "发券总数量 冗余字段";
    public static final String SCOPE_TYPE = "是否全店通用 1.是 0否 B端才有";
    public static final String PROMOTION_AMOUNT = "促销金额  [51无门槛现金抵用券|52满减券|53叠加满减券]";
    public static final String ORDER_FULL_AMOUNT = "订单满多少  [52满减券|53叠加满减券|56赠品券]}";
    public static final String PROMOTION_MAX_AMOUNT = "促销封顶金额  [53叠加满减券]";
    public static final String DISCOUNT_AMOUNT = "折扣（0和1之间）  [55折扣券]";
    public static final String GIFT_NAME = "赠品名称  [56赠品券]";
    public static final String PROMOTION_SCOPE_AMOUNT = "订单金额范围及促销金额 json格式 [54阶梯满减券]";
    public static final String APPLY_AUDIT_NAME = "申请审核人";
    public static final String APPLY_AUDIT_TIME = "申请审核时间";
    ...
    public static final String STATUS = "状态 1.已保存 2.报名中 3.进行中 4.已中止 5.已取消 6.已结束 7.已关闭  20.已上线(B端才有)  21.已下线(B端才有)";
    public static final String AUDIT_STATUS = "审核状态 0.初始状态 1.审核中 2.中止审核中 3.取消审核中";
    public static final String REBATE_SENDER = "补贴类别(0. 无 1. 商场联合大促 2. 红星大促)";
    public static final String EXT_RELATION_ID = "付费券才有,商场创建时为虚拟商户ID,格式为cx_sc_xxxx 商户创建时为商场ID";
    public static final String EXT_RELATION_NAME = "扩展名称";
    public static final String PROCESS_DATA_FLAG = "0.默认值 1.中止券在失效时对应用户券表中数据已处理[未使用->失效]";
    ...
    /**
     * @Fields processDataFlag : 0.默认值 1.中止券在失效时对应用户券表中数据已处理[未使用->失效]
     */
